 ...
 */
public class PairWiseConfigurationGeneratorWeightFeatures extends AConfigurationGenerator implements ITWiseConfigurationGenerator {
	...
	private static class FeatureIndex implements Comparable<FeatureIndex> {
		...
		public FeatureIndex(int index, double weight) {
			this.index  = index;
			this.weight = weight;
		}
